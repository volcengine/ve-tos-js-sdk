...
const objectKey10MChineseAndEmojiName = '10M 🍡对象';
describe('resumableCopyObject in node.js environment', () => {
  beforeAll(async done => {
    ...
    await client.resumableCopyObject({
      ...
      srcKey: objectKey10M,
      key: objectKey10MChineseAndEmojiName,
    });
    await sleepCache();
    done();
  }, NEVER_TIMEOUT);
  ...
  it(
    'copy for chinese and emoji source key',
    async () => {
      const srcKey = objectKey10MChineseAndEmojiName;
